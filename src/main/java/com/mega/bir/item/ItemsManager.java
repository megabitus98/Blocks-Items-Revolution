...
import com.mega.bir.item.items.ItemCatalyst;
...
public class ItemsManager {
    ...
    public static final ItemBir catalyst = new ItemCatalyst();
    ...
    public static void register(){
        ...
        GameRegistry.registerItem(catalyst, Names.Item_Catalyst);
    }
}
